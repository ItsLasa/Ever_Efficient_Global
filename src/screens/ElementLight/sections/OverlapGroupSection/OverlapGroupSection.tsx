...
// Define advantage card data for mapping
          ...
          <div className="flex flex-col gap-12 md:flex-row">
            ...
            <div className="flex-1">
              ...
              <div className="max-w-[551px] mb-10 [font-family:'Inter',Helvetica] font-normal text-everefficientlkwhite text-[15.8px] tracking-[0] leading-[28.8px]">
                ...
                solutions that drive real business growth and measurable
                results.
              </div>
    ...
    >
      <CardContent className="relative h-full p-0">
        ...
        <div className="absolute left-[85px] top-[22px] pr-5">
          ...
          <p className="text-sm text-everefficientlkslate-gray leading-[1.6]">
            {card.description}
          </p>
        </div>
