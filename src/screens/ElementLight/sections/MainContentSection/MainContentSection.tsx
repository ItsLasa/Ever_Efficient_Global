...
export const MainContentSection = (): JSX.Element => {
      ...
      <div className="flex flex-col items-center mb-12">
        <div className="relative flex items-center justify-center mb-4">
          <div className="relative pb-2 border-b-2 border-everefficientlkcerulean-blue w-[239px] flex items-center">
            ...
            />
            <div className="ml-2 text-2xl font-semibold text-center font-everefficient-lk-inter-bold-upper text-everefficientlkcerulean-blue">
              OUR SOLUTIONS
            </div>
          </div>
        </div>
        ...
        <div className="text-center text-5xl font-semibold max-w-[576px]">
          <h2 className="font-everefficient-lk-semantic-heading-2-title text-everefficientlkmirage">
            Transform Your
          </h2>
          <h2 className="font-everefficient-lk-semantic-heading-2-title">
          ...
          <p className="mt-6 text-lg font-normal text-zinc-700 text-[15px] leading-7 text-center max-w-[516px]">
            Comprehensive digital services designed to elevate your brand and
            drive
            measurable growth.
          </p>
        </div>
  ...
  {serviceCards.map((service) => (
    <Card
      key={service.id}
      className="group relative rounded-[50px_50px_50px_0px] overflow-hidden bg-white/60 backdrop-blur-md shadow-[12px_12px_30px_rgba(0,0,0,0.08)] hover:shadow-[16px_16px_40px_rgba(0,0,0,0.12)] transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.015]"
    >
